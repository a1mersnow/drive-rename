...
(function (vue) {
  ...
  const _sfc_main$3 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, { emit: __emit }) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("li", _hoisted_1$3, [
          ...
          !vue.unref(isSame) ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_3$3)) : (vue.openBlock(), vue.createElementBlock("span", _hoisted_4$2)),
          vue.createElementVNode("span", {
  ...
  const NakedEpisodeExtract = new RegExp("(?<![0-9])([0-9]{1,3})(?![0-9])(?![PK][._\\- ])", "i");
  function getNewNameByExtract(oldName, prefix, season, epHelpers) {
    let episode;
    if (epHelpers)
  ...
  const useMainStore = defineStore("main", () => {
    ...
    function getNewName(oldName, season2) {
      if (activeMode.value === "extract")
        return getNewNameByExtract(oldName, prefix.value.trim(), season2, { pre: epHelperPre.value, post: epHelperPost.value });
      else
  ...
  const _withScopeId = (n) => (vue.pushScopeId("data-v-1bf52951"), n = n(), vue.popScopeId(), n);
  const _hoisted_1$2 = { class: "custom-scrollbar fixed bottom-2 right-0 top-2 z-100 w-[max(500px,50vw)] overflow-y-auto border-y-3px border-l-3px border-primary-600 rounded-l-lg border-solid bg-white px-4 py-3 font-mono shadow" };
  const _hoisted_2$2 = {
    key: 0,
    class: "absolute inset-0 z-2 flex flex-col items-center justify-center bg-white/80 text-primary-600"
  };
  const _hoisted_3$2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "i-carbon:circle-packing animate-spin text-4xl" }, null, -1));
  ...
  const _sfc_main$2 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        const _component_PreviewEntry = _sfc_main$3;
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$2, [
          vue.unref(main).listLoading ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$2, [
            _hoisted_3$2,
          ...
          vue.createElementVNode("div", _hoisted_13$1, [
            ...
            vue.unref(main).activeMode === "extract" && vue.unref(main).videoList.length ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_14$1, [
          ...
          vue.unref(main).displayList.length ? (vue.openBlock(), vue.createElementBlock("ul", _hoisted_18$1, [
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(main).displayList, (item) => {
              ...
              }, null, 8, ["id", "old-name", "new-name", "model-value", "done", "error", "onUpdate:modelValue"]);
            }), 128))
  ...
  const __unplugin_components_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-1bf52951"]]);
  ...
  const _hoisted_1$1 = { class: "absolute z-100 mt-2 w-300px rounded-lg bg-primary-100 p-3 shadow" };
  const _hoisted_2$1 = { class: "pb-2" };
  ...
  const _hoisted_10 = { class: "grid gap-y-3 text-sm" };
  const _hoisted_11 = /* @__PURE__ */ vue.createElementVNode("label", { class: "mb-1 block" }, "From", -1);
  const _hoisted_12 = ["disabled"];
  const _hoisted_13 = /* @__PURE__ */ vue.createElementVNode("label", { class: "mb-1 block" }, "To", -1);
  const _hoisted_14 = ["disabled"];
  const _hoisted_15 = /* @__PURE__ */ vue.createStaticVNode('<div class="text-xs font-mono"><span class="text-#b07d48">原文件名</span><span class="text-#999">.</span><span class="text-#59873a">replace</span><span class="text-#2993a3">(</span><span class="text-#ab5959">new</span> <span class="text-#59873a">RegExp</span><span class="text-#1e754f">(</span><span class="text-#b07d48">From</span><span class="text-#1e754f">)</span><span class="text-#999">,</span> <span class="text-#b07d48">To</span><span class="text-#2993a3">)</span></div>', 1);
  const _hoisted_16 = { class: "mb-1 block flex items-center gap-x-2" };
  const _hoisted_17 = ["disabled"];
  const _hoisted_18 = /* @__PURE__ */ vue.createElementVNode("label", { class: "mb-1 block" }, "季", -1);
  const _hoisted_19 = ["disabled"];
  const _hoisted_20 = { class: "min-h-40px" };
  const _hoisted_21 = {
    key: 0,
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$1, [
          vue.createElementVNode("p", _hoisted_2$1, [
            ...
            _hoisted_3$1,
            vue.unref(updateMsg) ? (vue.openBlock(), vue.createElementBlock("a", _hoisted_4, vue.toDisplayString(vue.unref(updateMsg)), 1)) : vue.createCommentVNode("", true)
          ]),
          ...
          vue.createElementVNode("div", _hoisted_10, [
            ...
            vue.createElementVNode("div", _hoisted_20, [
              vue.unref(main).error ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_21, vue.toDisplayString(vue.unref(main).error), 1)) : vue.unref(main).processData.total ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_22, " 总共 " + vue.toDisplayString(vue.unref(main).processData.total) + " | 跳过 " + vue.toDisplayString(vue.unref(main).processData.skip) + " | 完成 " + vue.toDisplayString(vue.unref(main).processData.done), 1)) : vue.createCommentVNode("", true),
              vue.unref(main).warning ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_23, vue.toDisplayString(vue.unref(main).warning), 1)) : vue.createCommentVNode("", true)
            ]),
            vue.createElementVNode("div", _hoisted_24, [
              vue.createElementVNode("button", {
                ...
                vue.unref(main).running ? (vue.openBlock(), vue.createElementBlock("i", _hoisted_26)) : vue.createCommentVNode("", true),
  ...
  const _hoisted_1 = /* @__PURE__ */ vue.createElementVNode("i", { class: "i-carbon:batch-job text-xl" }, null, -1);
  const _hoisted_2 = /* @__PURE__ */ vue.createElementVNode("span", { class: "text-xs font-medium" }, "重命名", -1);
  const _hoisted_3 = [
    _hoisted_1,
    _hoisted_2
  ];
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
          vue.unref(main).shouldShowEntry ? (vue.openBlock(), vue.createElementBlock("button", {
            key: 0,
            ref_key: "triggerRef",
            ref: triggerRef,
