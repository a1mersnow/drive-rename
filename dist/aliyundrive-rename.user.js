...
(function (vue) {
  ...
  const SeasonEpisodeExtract = new RegExp("S(?:eason)?[._\\- ]?([0-9]{1,3})(?![0-9])(?:[._\\- ]?E|[._\\- ])([0-9]{1,3})(?![0-9])|EP?([0-9]{1,3})(?![0-9])|(?<![0-9])([0-9]{1,3})(?![0-9])(?![PK][._\\- ])", "i");
  ...
  function getEpisode(oldName) {
    ...
    const normalize = (x) => String(+x).padStart(3, "0");
  ...
  const _withScopeId = (n) => (vue.pushScopeId("data-v-2367c4c5"), n = n(), vue.popScopeId(), n);
  ...
  const _hoisted_28 = { class: "pb-1 text-xs text-gray" };
  const _hoisted_29 = { key: 0 };
  const _hoisted_30 = { key: 1 };
  const _hoisted_31 = { key: 2 };
  const _hoisted_32 = { class: "flex items-center gap-x-3 pb-2" };
  const _hoisted_33 = {
    key: 0,
    class: "ml-4 text-sm text-gray-600"
  };
  const _hoisted_34 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("i", { class: "i-carbon:pointer-text [vertical-align:-0.2em] inline-block text-sm text-green-700" }, null, -1));
  const _hoisted_35 = {
    key: 1,
    class: "ml-auto text-xs text-gray-600 font-sans"
  };
  const _hoisted_36 = { class: "text-primary-600 font-bold" };
  const _hoisted_37 = {
    key: 1,
    ...
    setup(__props) {
      ...
      function getNewName(oldName, season2) {
        if (activeMode.value === "extract")
          return getNewNameByExtract(oldName, prefix.value.trim(), season2);
        else
            ...
            default: vue.withCtx(() => [
              vue.unref(popupVisible) ? (vue.openBlock(), vue.createElementBlock("div", {
                ...
                vue.createElementVNode("div", _hoisted_28, [
                  vue.unref(hasConflict) ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_29, "❌ 文件名有冲突！")) : vue.unref(selectedList).length ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_30, "✅ 准备就绪")) : (vue.openBlock(), vue.createElementBlock("span", _hoisted_31, "⌛ 暂无改动"))
                ]),
                vue.createElementVNode("div", _hoisted_32, [
                  ...
                  vue.unref(activeMode) === "extract" && vue.unref(videoList).length ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_33, [
                    vue.createTextVNode(" 点击 "),
                    _hoisted_34,
                    vue.createTextVNode(" 可将其填充到“剧名” ")
                  ])) : vue.createCommentVNode("", true),
                  vue.unref(showList).length ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_35, [
                    vue.createTextVNode(" 共 "),
                    vue.createElementVNode("span", _hoisted_36, vue.toDisplayString(vue.unref(showList).length), 1),
                    vue.createTextVNode(" 个文件 ")
                  ])) : vue.createCommentVNode("", true)
                ]),
                vue.unref(showList).length ? (vue.openBlock(), vue.createElementBlock("ul", _hoisted_37, [
                ...
                ])) : (vue.openBlock(), vue.createElementBlock("div", _hoisted_38, " 当前目录和模式下，没有满足要求的条目~ "))
  ...
  const AppRoot = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2367c4c5"]]);
