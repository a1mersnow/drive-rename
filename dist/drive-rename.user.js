...
(function (vue, dayjs, jsMd5) {
  ...
  const _sfc_main$7 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, { emit: __emit }) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("li", _hoisted_1$5, [
  ...
  async function getFileListOfCurrentDir$4(parentId = getParentId$2()) {
    ...
    while (next) {
      ...
      const { data: { InfoList, Next } } = await get$1(listApi);
      result.push(...InfoList.map((x) => ({
        drive_id: "whocare",
        file_id: x.FileId,
        name: x.FileName,
        parent_file_id: x.ParentFileId,
        file_extension: getExt$1(x.FileName),
        mime_type: "whocare",
  ...
  const headers$3 = {};
  function setRequestHeader$4(key, value) {
  ...
  async function renameOne$4(resource, newName) {
    return post$3("https://www.123pan.com/b/api/file/rename", {
      driveId: 0,
  ...
  const ButtonComponent$1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$1]]);
  function getToken$1() {
  ...
  const providers = /* @__PURE__ */ Object.assign({ "/src/providers/123.ts": __vite_glob_0_0, "/src/providers/aliyun.ts": __vite_glob_0_1, "/src/providers/cmcc.ts": __vite_glob_0_2, "/src/providers/quark.ts": __vite_glob_0_3 });
  function resolveProvider() {
    for (const path in providers) {
      const provider2 = providers[path].default;
      if (provider2.HOSTS.includes(location.host))
        return provider2;
    }
  ...
  const _sfc_main$2 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        const _component_PreviewEntry = _sfc_main$7;
