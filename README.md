...
> [!NOTE]
> 由于Chrome对扩展程序的限制加强，此脚本可能需要以下操作才能正常使用：
> 1. 右上角三个点->扩展程序->管理扩展程序->右上角启用“开发者模式”
> 2. 找到“篡改猴/Tampermonkey”扩展，进入详情，启用“允许运行用户脚本“
> 3. 重新启动浏览器
...
使用正则表达式对文件名做查找替换，采用 Javascript 的 `String.prototype.replace` 方法。
